...
<?php }?>
	...
	<div class="navbar-inner">
		...
		<span class="brand" style="margin-left:17px;">For Technical Support Mail Us: waytopinnacle.mcq@gmail.com</span>
			...
			<div class="nav-collapse nav-collapse-top collapse">
                ...
                <ul class="nav pull-right">
					<li class="dropdown">
					<a href="admin_profile.php" ><i class="icon-building"></i><?php echo $query_center_name['centername'];?> </a>
					</li>
					<li class="dropdown">
