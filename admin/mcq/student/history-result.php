...
if($_GET['exam_id']!="")
{
	...
	$query_check_center=mysqli_query($con,"select * from practice_exam where  p_e_id='".$p_e_id."' and exam_status=1");
...
$query=mysqli_query($con,"select * from practice_exam where  center_id='".$row_check_center['center_id']."' and p_e_id='".$p_e_id."' and exam_status=1");
...
{
	 $query1 = " SELECT max(exam_date) FROM practice_exam_status WHERE exam_id ='".$p_e_id."' AND center_id ='".$_SESSION['center_id']."' AND student_id ='".$_SESSION['student_id']."'";
...
$query_answer="select * from practice_answer where student_id='".$_SESSION['student_id']."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and practice_exam_status_id='".$query_exam_take_status['id']."'";
mysqli_query($con,$query_answer);
