										...
										<table style="width:100%;vertical-align:top" class="table table-normal">
											<tr>
												<td style="vertical-align:top">						
													<?php
													$query_pag_data = mysqli_query($con,"SELECT * from practice_question where p_e_id='".$e_id."' and center_id='".$_SESSION['center_id']."' and question_status=1 and c_id='".$category_id."' and s_c_id='".$subcategory_id."' order by rand()");
													...
													?>
													<div <?php if($i==1){}else{echo 'style="display: none;"';}?> id="<?php echo $p_e_id;?>_<?php echo $i;?>" class="display_question">
													...
													<tbody>
													<tr>
													<td style="width:10px"><input name="radio_<?php echo $result['p_q_id'];?>" value="A" id="" type="radio"></td>
													<td><?php echo $result['option_a'];?>                       </td>
													</tr>
													<tr>
													<td>
													<input name="radio_<?php echo $result['p_q_id'];?>" value="B" id="" type="radio"></td><td>
													<?php echo $result['option_b'];?>                        </td>
													</tr>
													<tr>
													<td>
													<input name="radio_<?php echo $result['p_q_id'];?>" value="C" id="" type="radio"></td><td>
													<?php echo $result['option_c'];?>                        </td>
													</tr>
													<tr>
													<td>
													<input name="radio_<?php echo $result['p_q_id'];?>" value="D" id="" type="radio"></td><td>
													...
													<tbody><tr>
													<td style="width:10px">
													<input name="checkbox_A_<?php echo $result['p_q_id'];?>" value="A" id="" type="checkbox"></td><td>
													<?php echo $result['option_a'];?>                        </td>
													</tr>
													<tr>
													<td>
													<input name="checkbox_B_<?php echo $result['p_q_id'];?>" value="B" id="" type="checkbox"></td><td>
													<?php echo $result['option_b'];?>                       </td>
													</tr>
													<tr>
													<td>
													<input name="checkbox_C_<?php echo $result['p_q_id'];?>" value="C" id="" type="checkbox"></td><td>
													<?php echo $result['option_c'];?>                      </td>
													</tr>
													<tr>
													<td>
													<input name="checkbox_D_<?php echo $result['p_q_id'];?>" value="D" id="" type="checkbox"></td><td>
													<?php echo $result['option_d'];?>                       </td>
													</tr>
													</tbody>
													</table>
								...
								<div class="awareness-view"><h4 class="awareness-view-hed"><small><?php echo constant('TI_LABEL_QUESTION_PALETTE');?></small></h4>
									<div class="col-md-12">
										<div class="number-plate">
											<?php
											$j=1;
											$query_pag_data1 = mysqli_query($con,"SELECT * from practice_question where p_e_id='".$e_id."' and center_id='".$_SESSION['center_id']."' and question_status=1 and c_id='".$category_id."' and s_c_id='".$subcategory_id."' order by rand()");
											while($result_buttom=mysqli_fetch_array($query_pag_data1)){
											?>
												<li id="number-<?php echo $p_e_id;?>_<?php echo $j;?>" onclick="showQuestion('#<?php echo $p_e_id;?>_<?php echo $j;?>');" class="btn bg-primary numbers z-answered"><?php echo $j;?>  </li>
											<?php $j++;}?>
										</div>
									</div>
								</div>
