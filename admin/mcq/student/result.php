...
if($row['re_exam_day']==0)
{
	...
	else
	{
		...
		if($days >= $re_exam_day)
		{
			...
			$query="insert into practice_exam_status (category_id,subcategory_id,subject_id,exam_id,exam_date,status,student_id,center_id,noofattemps) values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."',now(),1,'".$_SESSION['student_id']."','".$center_id."','".$noofattemps."')";
...
if($days >= $re_exam_day)
{
	...
	echo $query=mysqli_query($con,"insert into practice_exam_status (category_id,subcategory_id,subject_id,exam_id,exam_date,status,student_id,center_id,noofattemps) values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."',now(),1,'".$_SESSION['student_id']."','".$center_id."','".$noofattemps."')");
	$last_insert_id=mysqli_insert_id($con);
