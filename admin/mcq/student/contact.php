...
{ 
	...
	$query_center_result=mysqli_fetch_array(mysqli_query($con,"select * from center where c_id='".$_SESSION['center_id']."'"));
	...
	$query_category_result=mysqli_fetch_array(mysqli_query($con,"select * from category where c_id='".$query_student_result['category_id']."'"));
			$messages="<html><body>
			<table>
			<tr><td>Hi ".$query_center_result['centername'].",</td></tr>	
			<tr><td>&nbsp;</td></tr>
			<tr><td>".$message."</td></tr>											
			<tr><td>&nbsp;</td></tr>									
		...
		<ul class="nav nav-tabs nav-tabs-left">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo constant('TI_LABEL_CONTACT_CENTER');?></a></li>
				<li>
