...
if($_SESSION['student_id']!="" and $_SESSION['center_id']!="")
{
	...
	$center_result=mysqli_fetch_array(mysqli_query($con,"select * from center where c_id='".$_SESSION['center_id']."'"));
				...
				<div class="padded">       
						...
						<div class="padded">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                   <select name="c_id" class="chzn-select" readonly>								
									<option value="<?php echo $_SESSION['center_id'];?>" <?php if($center_result['c_id']==$result['center_id']){echo 'selected="selected"';}?>><?php echo $center_result['centername'];?></option>  </select> </select>
								</div>
                            </div>
                        </div>
						 ...
						 <div class="padded">  
							<div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_CENTER_ADDRESS_CENTER');?> </label>
                                <div class="controls">                                    
									<div class="box closable-chat-box">									
										<div class="chat-message-box">
										<?php echo $center_result['centeraddress'];?>								
										</div>
									</div>
                                </div>
                            </div>							
