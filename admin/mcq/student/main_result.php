...
if($row['re_exam_day']=="")
{
	...
	else
	{
		...
		if($days >= $re_exam_day)
		{
			...
			{
			$query_question=mysqli_query($con,"select * from question where q_id='".$question_id_get_explode[$q]."' and question_status=1"); 
			...
			$query="insert into main_exam_status (category_id,subcategory_id,subject_id,exam_id,exam_date,status,student_id,center_id,noofattemps) values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."',now(),1,'".$_SESSION['student_id']."','".$center_id."','".$noofattemps."')";
			...
			for($i=0;$i<$count; $i++)
			{
				...
				{
					$qid=$q_id[$i];
					$query_question_typeofquestion=mysqli_fetch_array(mysqli_query($con,"select * from question where q_id='".$q_id[$i]."'  and question_status=1")); 
					if($query_question_typeofquestion['typeofquestion']=='Single')
					{
						...
						if($_POST[$radio]!="")
						{
							...
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$_POST[$radio]."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");

						}
						else
						{
					
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
					...
					{			
						...
						if($_POST[$checkbox_A]!="" || $_POST[$checkbox_B]!="" || $_POST[$checkbox_C]!="" || $_POST[$checkbox_D]!="")
						{
							...
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$checkbox."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
						}
						else
						{								
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
						}
					}					
				}
			}
...
echo $query="insert into main_exam_status (category_id,subcategory_id,subject_id,exam_id,exam_date,status,student_id,center_id,noofattemps) values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."',now(),1,'".$_SESSION['student_id']."','".$center_id."','".$noofattemps."')";
$data=mysqli_query($con,$query);
$last_insert_id=mysqli_insert_id($con);
...
else
{
 $tscore=$total_marks_score;
	...
	$message.="<td class='news-title'>".$tscore."</td>";
	$message.="</tr>";
	$message.="<tr>";
...
$email.="<tr><td style='line-height:30px; color:#7087A3;font-size:20px;padding-left:5px'></td></tr>";
$email.="<tr>";
$email.="<td>";
...
// 		$email.="</tr>";
 ...
 $data="select * from main_answer where student_id='".$_SESSION['student_id']."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'";
	$query_answer_table1=mysqli_query($con,$data);
	$i=1;
	while($questin_result1=mysql_fetch_array($query_answer_table1))
	{	
			
			
		if($questin_result1['typeofquestion']=='Single')
		{				
			if($questin_result1['ans']=='A')
			{
				$user_ans_single=$questin_result1['option_a'];
			}
			if($questin_result1['ans']=='B')
			{
				$user_ans_single=$questin_result1['option_b'];
			}
			if($questin_result1['ans']=='C')
			{
				$user_ans_single=$questin_result1['option_c'];
			}
			if($questin_result1['ans']=='D')
			{
				$user_ans_single=$questin_result1['option_d'];
			}
			if($questin_result1['ans']=='Not Answer')
			{
				$user_ans_single='Not Answer';
			}
		}
		else
		{
			...
			if($explode[0]=='A' and $explode[0]!="")
			{
				$user_ans_a=$questin_result1['option_a']."<br>";
			}
			if($explode[1]=='B' and $explode[1]!="")
			{
				$user_ans_b=$questin_result1['option_b']."<br>";
			}
			if($explode[2]=='C' and $explode[2]!="")
			{
				$user_ans_c=$questin_result1['option_c']."<br>";
			}
			if($explode[3]=='D' and $explode[3]!="")
			{
				$user_ans_d=$questin_result1['option_d'];
			}
			if($explode[0]=='Not Answer' and $explode[0]!="")
			{
				$user_ans_not_ans='Not Answer'."<br>";
		...
		if($questin_result1['typeofquestion']=='Single')
		{				
			if($questin_result1['correct_ans']=='A')
			{
				$correct_ans_single=$questin_result1['option_a'];
			}
			if($questin_result1['correct_ans']=='B')
			{
				$correct_ans_single=$questin_result1['option_b'];
			}
			if($questin_result1['correct_ans']=='C')
			{
				$correct_ans_single=$questin_result1['option_c'];
			}
			if($questin_result1['correct_ans']=='D')
			{
				$correct_ans_single=$questin_result1['option_d'];
			}
		}
		else
		{			
			$correct_ans_multi=$questin_result1['correct_ans'];
			$explode_correct_ans_multi=explode("-",$correct_ans_multi);				
			$correct_ans_a="";
			$correct_ans_b="";
			$correct_ans_c="";
			...
			if($explode_correct_ans_multi[0]=='A' and $explode_correct_ans_multi[0]!="")
			{
				$correct_ans_a=$questin_result1['option_a']."<br>";
			}
			if($explode_correct_ans_multi[1]=='B' and $explode_correct_ans_multi[1]!="")
			{
				$correct_ans_b=$questin_result1['option_b']."<br>";
			}
			
			if($explode_correct_ans_multi[2]=='C' and $explode_correct_ans_multi[2]!="")
			{
				$correct_ans_c=$questin_result1['option_c']."<br>";
			
			}
			if($explode_correct_ans_multi[3]=='D' and $explode_correct_ans_multi[3]!="")
			{
				$correct_ans_d=$questin_result1['option_d'];
			}
			  $correct_ans_multi=$correct_ans_a." ".$correct_ans_b." ".$correct_ans_c." ".$correct_ans_d;
		}
			...
			$email.="<td valign='top' style='border-bottom:1px solid #ccc;border-right:1px solid #ccc;line-height:30px;font-size:14px;padding-left:5px'>".nl2br($questin_result1['question'])."</td>";

			$email.="<td valign='top' style='border-bottom:1px solid #ccc;border-right:1px solid #ccc;line-height:30px;font-size:14px;padding-left:5px'>".$questin_result1['marks']."</td>";
			...
			if($questin_result1['ans']== $questin_result1['correct_ans'])
			{
				$symbol= '&#10004;';
			}
			else
