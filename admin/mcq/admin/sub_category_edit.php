...
{	
	...
	$query_select_sub_category=mysqli_query($con,"SELECT * FROM subcategory where subcategory_name='".$subcategory_name."' and category_id='".$category_name."'");
	...
	else
	{
		...
		$query_update_mysql_subcategory=mysqli_query($con,"update subcategory set category_id='{$category_name}',subcategory_name='{$subcategory_name}' where s_c_id='".$_POST['s_c_id']."'");

		if($query_update_mysql_subcategory)
		{
			$message_success .=$subcategory_name." ". constant('TI_SUB_CATEGORY_EDIT_MESSAGE');			
		}
		else
		{
		...
		<div class="row-fluid">
			<div class="area-top clearfix">
				<div class="pull-left header">
					<h3 class="title"><i class="icon-edit"></i><?php //echo constant('TI_MANAGE_SUB_CATEGORY');?> Manange Course Level</h3>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="box">
			<div class="box-header">    	
				<ul class="nav nav-tabs nav-tabs-left">
					<li class="active">
						<a href="#add" data-toggle="tab"><i class="icon-wrench"></i><?php //echo constant('TI_SUBCATEGORY_EDIT_BUTTON');?>Edit Course Level</a>
					</li>
				</ul>	
			</div>
			...
			<div class="tab-pane active" id="add" style="padding: 5px">
				<form method="post" action="" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php //echo constant('TI_SUBCATEGORY_EDIT_BUTTON');?>Save Course Level </button>
