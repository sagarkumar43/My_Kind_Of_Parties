                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <?php 
							...
							?>
								...
								<?php if($query_center['center_id']==$row['c_id']){?>
							     
								<input type="checkbox" id="cb1_1" class="cbgroup1" name="cbg1[]" value="<?php echo $row['c_id']?>" checked>
								<?php }else{?>
								<input type="checkbox" id="cb1_1" class="cbgroup1" name="cbg1[]" value="<?php echo $row['c_id']?>">
								<?php }?>
