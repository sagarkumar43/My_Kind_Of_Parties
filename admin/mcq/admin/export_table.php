...
{
    	$QuestionDimArray []= array ( $data_question['q_id'],$data_question['s_id'],$data_question['c_id'], $data_question['s_c_id'], $data_question['question'], $data_question['typeofquestion'],$data_question['option_a'],$data_question['option_b'], $data_question['option_c'], $data_question['option_d'],$data_question['correct_ans'],$data_question['question_status'],$data_question['marks'] );
    print_r($QuestionDimArray);
...
$dop_filename = 'TI_OES_'.date('Y_m_d_H_i_s').'.xls';
...
$writer->writeSheet($QuestionDimArray,'sheet4',$header_question); // Excel sheet 4
		...
		<div class="container-fluid padded">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<form action="download_excel.php" method="post" accept-charset="utf-8" class="form-horizontal validatable" target="_top">	
						<div class="padded">       
