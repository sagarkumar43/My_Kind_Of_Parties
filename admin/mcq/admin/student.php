...
{ 
	...
	$icai= mysql_prep($_POST['icai_num']);
                	...
                	<thead>
                		<tr>
							...
							<th><div><?php echo constant('TI_TABLE_CENTER_NAME') ?></div></th>
								<th><div><?php //echo constant('TI_TABLE_CENTER_NAME') ?>ICAI Number</div></th>
							...
							<th><div><?php echo constant('TI_TABLE_BATCH_NAME_TIME') ?></div></th>
								<th><div><?php //echo constant('TI_TABLE_BATCH_NAME_TIME') ?>Phone </div></th>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
               <div class="box-content">
                  <form action="<?php $PHP_SELF ?>" method="post" accept-charset="utf-8" class="form-horizontal validatable" target="_top">
                        ...
                        <div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php //echo constant('TI_LABEL_STUDENT_NAME');?>ICAI Number<span style="color:red"> * </span></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="icai_num"/>
                                </div>
                            </div>
                        </div>
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_NAME');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_FATHER_NAME');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_MOTHER_NAME');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_DOB');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_ADDRESS');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_PHONE');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">                   
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_STUDENT_EMAIL');?><span style="color:red"> * </span></label>
                                <div class="controls">
						...
						<div class="padded">  
							<div class="control-group">
                                <label class="control-label"><?php echo constant('TI_PASSWORD');?><span style="color:red"> * </span></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo constant('TI_STUDENT_ADD_BUTTON');?><span style="color:red"> * </span></button>
