...
{ 
	...
	$show_question=$_POST['show_question'];
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	<thead>
                		<tr>
							...
							<th><div><?php //echo constant('TI_TABLE_SUB_CATEGORY_NAME') ?>Course Level</div></th>
							<th><div><?php //echo constant('TI_TABLE_SUB_CATEGORY_NAME') ?>Center</div></th> 
							<th><div><?php echo constant('TI_TABLE_SUBJECT_NAME') ?></div></th>
							<th><div><?php echo constant('TI_TABLE_EXAM_NAME') ?></div></th>
							<th><div>Exam Date Start</div></th>
					    	<th><div>Exam Date End</div></th>	
                    ...
                    <tbody>
							<?php 
								...
								{ 
									...
									$query_center_name=mysqli_fetch_array(mysqli_query($con,"select * from center where c_id='".$row['center_id']."'"));
									   ...
									   $exam_date_end= mysql_prep($row['date_end']);

										if($exam_date!="" && $exam_date_end!="")
										{
										...
										$date_explode1=explode("-",$exam_date_end);
										
										$date_month=$date_explode1[1];
										$date_year=$date_explode1[0];
										$date_day=$date_explode1[2];
										$exam_date__end_format=$date_day.'-'.$date_month.'-'.$date_year;
										}
							...
							?>
								...
								<td><?php echo $exam_date__end_format;?> </td>
					...
					<div class="padded">       
							<div class="control-group">
                                ...
                                <div class="controls">
									...
									<option><?php //echo constant('TI_SELECT_CATEGORY');?>Select Center</option>  
										...
										while($result_category1=mysqli_fetch_array($query_center))
										{
										?>
                                    	<option value="<?php echo $result_category1['c_id'];?>"><?php echo ucfirst($result_category1['centername']);?></option>
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo constant('TI_LABEL_SUBJECT_NAME');?></label>
                                 <div class="controls" id="subjectdiv">
                                    	...
                                    	<?php //echo constant('TI_SELECT_SUB_CATEGORY_FIRST');?>Select Course Level First
						...
						<div class="padded">                   
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="exam_date_end"  class="validate[required] datepicker"/>
                                </div>
                            </div>
                        </div>
