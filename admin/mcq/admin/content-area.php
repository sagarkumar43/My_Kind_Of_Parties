...
$query5=mysqli_query($con,"select * from center");
confirm_query($query5);
$num_center=mysqli_num_rows($query5);
$query5s=mysqli_query($con,"select * from center where center_status=1");
				...
				<div class="action-nav-normal">
					<div class="row-fluid">
						...
						{?>
							<div class="span2 action-nav-button">
								...
								<span><?php echo constant('TI_DESBOARD_ICON_CATEGORY');?></span> 
						...
						{?>
							<div class="span2 action-nav-button">
								...
								<i class="icon-tags"></i> 
								<span><?php echo constant('TI_DESBOARD_ICON_SUB_CATEGORY');?></span>
						...
						if (in_array("4", $explode_permistion) or in_array("0", $explode_permistion))
						{
							...
							<div class="span2 action-nav-button">
								<a href="subject.php">
								<i class="icon-tag"></i> 
								<span><?php echo constant('TI_DESBOARD_ICON_SUBJECT');?></span>
						...
						{?>
							...
							<div class="span2 action-nav-button">
								...
								<span><?php echo constant('TI_DESBOARD_ICON_CENTER');?></span>
					...
					if (in_array("11", $explode_permistion) or in_array("0", $explode_permistion))
					{
						...
						<div class="span2 action-nav-button">
							...
							<span><?php echo constant('TI_DESBOARD_ICON_NOTICE');?></span>
						...
						<?php }if (in_array("13", $explode_permistion) or in_array("0", $explode_permistion))
						{?>
						<div class="span2 action-nav-button">
				...
				<div class="box-content scrollable" style="max-height: 500px; overflow-y: auto">
					...
					$query_category_exam=mysqli_query($con,"select * from exam");
						...
						{	
							...
							$query_main_exam_status=mysqli_query($con,"select * from main_exam_status where exam_id='".$result_category_exam['e_id']."' and exam_date >= '".$current_date."'");
