...
{ 
	...
	$query_insert_category = "INSERT INTO batch (batch_name,batch_time) VALUES('{$batch_name}','{$batch_time}')";
						...
						<div class="tab-content">        
							<div class="tab-pane box active" id="list">
								<table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
									...
									<tbody>
										<?php 
											$query=mysqli_query($con,"SELECT * FROM batch ORDER BY batch_name");
											$i=0;
											...
											<tr>
												...
												<td align="center">
													<a data-toggle="modal" href="batch_edit.php?b_id=<?php echo $row['b_id']; ?>" class="btn btn-gray btn-small"><i class="icon-wrench"></i> <?php echo constant('TI_EDIT_BUTTON');?></a>
