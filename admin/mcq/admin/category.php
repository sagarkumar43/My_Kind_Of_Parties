...
{ 
	...
	{
		$error .= $category_name. constant('TI_CATEGORY_ERROR_ALLREADY_EXIT');
	}
	else
	{
		$query_insert_category = "INSERT INTO category (category_name) VALUES('{$category_name}')";
		$result_category=mysqli_query($con,$query_insert_category);
		if($result_category)
		{
			$message_success .=$category_name." ". constant('TI_CATEGORY_ADD_MESSAGE');
		}
		else
		{
			$error .=  constant('TI_CATEGORY_MYSQL_ERROR');
		}
	}	
}
            ...
            <div class="row-fluid">
                <div class="area-top clearfix">
                    <div class="pull-left header">
                        <h3 class="title">
                        <i class="icon-edit"></i>
                        <?php //echo constant('TI_MANAGE_CATEGORY');?>Manage Course </h3>
                    </div>
                </div>
            </div>
        </div>       
				...
				<?php include("message.php");?>
					<div class="box-header">    
						<ul class="nav nav-tabs nav-tabs-left">
							<li class="active">
								<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i><?php //echo constant('TI_CATEGORY_LIST');?>Course List</a>
							</li>
							<li>
								<a href="#add" data-toggle="tab"><i class="icon-plus"></i><?php //echo constant('TI_CATEGORY_ADD');?>Add Course</a>
							</li>
						</ul>  
					</div>
									...
									<div class="box-content">
										<form action="<?php $PHP_SELF ?>" method="post" accept-charset="utf-8" class="form-horizontal validatable" target="_top">					
											...
											<div class="form-actions">
												<button type="submit" class="btn btn-gray"><?php //echo constant('TI_CATEGORY_ADD_BUTTON');?>Add Course</button>
...
<div id="modal-delete" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_POPUP_DELETE_CATEGORY');?></div>
    <div class="modal-footer">
