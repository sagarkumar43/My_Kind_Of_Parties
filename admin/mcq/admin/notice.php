...
echo	$query_insert_notice = "INSERT INTO notice (noitce,notice_subject,notice_date,status,admin_id) VALUES('{$notice_textarea}','{$notice_subject}','{$notice_date_from}',1,'{$_SESSION['user_id']}')";
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	<thead>
                		<tr>
							...
							<th><div><?php echo constant('TI_LABEL_DATE');?></div></th>
                    ...
                    <tbody>
							...
							?>
								...
								<a data-toggle="modal" href="noticecenter.php?n_id=<?php echo $row['n_id'];?>" class="btn btn-green btn-small"><i class="icon-user"></i> <?php echo constant('TI_DESBOARD_ICON_CENTER');?></a>
