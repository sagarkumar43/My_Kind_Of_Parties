            ...
            <div class="tab-pane box active" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
						...
						$query=mysqli_query($con,"select * from main_exam_status where student_id='".decrypt_string($_GET['sid'])."' and category_id='".decrypt_string($_GET['caid'])."' and center_id='".decrypt_string($_GET['ceid'])."' and status=1" );
								$i=0;
							...
							?>
								...
								<td align="center">
									<a data-toggle="modal" target="_new" href="history-main-result.php?exam_id=<?php echo encrypt_string($row['exam_id']);?>&exam_dy=<?php echo encrypt_string($row['exam_date']);?>&sid=<?php echo $_GET['sid'];?>&caid=<?php echo $_GET['caid'];?>&ceid=<?php echo $_GET['ceid'];?>" class="btn btn-gray btn-small"><i class="icon-wrench"></i> <?php echo constant('TI_VIEW_RESULT_BUTTON') ?></a>	
