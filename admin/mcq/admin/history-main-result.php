...
if($_GET['exam_id']!="")
{
	...
	if(in_array(decrypt_string($_GET['ceid']),$center_id_explode))
	{
		$center_id=decrypt_string($_GET['ceid']);
...
$query=mysqli_query($con,"select * from exam where  center_id='".$row_check_center['center_id']."' and e_id='".$p_e_id."' and exam_status=1");
...
else
{
		 ...
		 $query1 = " SELECT max(exam_date) FROM main_exam_status WHERE exam_id ='".$p_e_id."' AND center_id ='".$center_id."' AND student_id ='".$student_id."'";
...
$query_exam_take_status=mysqli_fetch_array(mysqli_query($con,"select * from main_exam_status where exam_id='".$e_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and subject_id='".$exam_name['subject_id']."' and center_id='".$center_id."' and student_id='".$student_id."' and exam_date='".$given_exam_date."'"));



$query_answer=mysqli_query($con,"select * from main_answer where student_id='".$student_id."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
...
$query_status_count=mysqli_query($con,"select * from main_answer where student_id='".$student_id."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
...
$query_answer_table=mysqli_query($con,"select * from main_answer where student_id='".$student_id."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
	$i=1;
