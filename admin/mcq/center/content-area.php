				...
				<div class="box-content scrollable" style="max-height: 500px; overflow-y: auto">
					...
					<?php 					
						...
						{	
							...
							$query_main_exam_status=mysqli_query($con,"select * from main_exam_status where exam_id='".$result_category_exam['e_id']."' and exam_date >= '".$current_date."' and center_id='".$_SESSION['center_id']."'");
