...
echo	$query_insert_notice = "INSERT INTO notice (noitce,notice_subject,notice_date,status,center_id) VALUES('{$notice_textarea}','{$notice_subject}','{$notice_date_from}',1,'{$_SESSION['center_id']}')";
