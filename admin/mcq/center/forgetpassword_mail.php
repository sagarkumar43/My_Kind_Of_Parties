...
include('include/configure.php');
		...
		{
			$query="select * from center where email='".$_POST['email']."'";
			...
			if (mysqli_num_rows($result_set) == 1)
			{
				...
				$to =$_POST['email'];
				$subject=constant('TI_MAIL_FORGET_SUBJECT')." ".$found_user['centername'];

				$message .= "<b style='font-size:20px;line-height:25px'> " . htmlspecialchars($found_user['centername'], ENT_QUOTES) . "</b>,<br>\n";
				...
				$message .= $found_user['centername']."<br>\n";
				$message .="<b>Contact:</b> ". $found_user['phoneno']."<br>\n";
