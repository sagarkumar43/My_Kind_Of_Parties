...
{	
	...
	$b_id= $_POST['b_id'];
		 ...
		 $query_update_mysql_student=mysqli_query($con,"update student set category_id='{$category_id}', center_id='{$center_id}', b_id='{$b_id}',student_name='{$student_name}', student_father='{$student_father}',student_mother='{$student_mother}',student_address='{$student_address}',student_phone='{$student_phone}',student_email='{$student_email}',password='{$password}',password_md5='{$password_md5}' where student_id='".$_POST['student_id']."'");
				...
				<form method="post" action="" class="form-horizontal validatable" enctype="multipart/form-data">
						...
						<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
								   ...
								   {?>
                                    <option value="<?php echo $result_center['c_id'];?>" <?php if($result_center['c_id']==$result['center_id']){echo 'selected="selected"';}?>><?php echo $result_center['centername'];?></option>
								   <?php }
								   ?>
								   </select>
                                </div>
						...
						<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required,custom[email]]" name="student_email" value="<?php echo $result['student_email']; ?>" />
                                </div>
                            </div>
                        </div>
