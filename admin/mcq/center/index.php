...
if($_POST['login_type']=='center')
{
		...
		else
		{
			...
			$query="SELECT * FROM center WHERE email='{$email}' AND password_md5='{$password}' AND center_status=1";
			$result_set = mysqli_query($con,$query);
			confirm_query($result_set);
			if (mysqli_num_rows($result_set) == 1) 
			{
				$found_user = mysqli_fetch_array($result_set);			
				$_SESSION['center_id'] = $found_user['c_id'];
				$_SESSION['centeremail'] = $found_user['email'];
				$_SESSION['center_username'] = $found_user['username'];
				$_SESSION['cente_rname'] = $found_user['centername'];
                    ...
                    <div class="container-fluid">                        
						...
						<ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo constant("TI_LOGIN_HEADER_SELECT_SECTION");?> <b class="caret"></b></a>
								...
								<li><a href="index.php"><?php echo constant("TI_LOGIN_HEADER_CENTER");?></a></li>  
                    ...
                    <div class="padded" style="margin-top:10px">
						...
						<!--<center>						
							...
							else if($_GET['blank']==1)
							{
							 ...
							 {
								  echo "<center style='font-size: 16px;'>ims.mcq@gmail.com</center>";
