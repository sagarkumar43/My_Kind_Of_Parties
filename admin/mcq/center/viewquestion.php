		...
		<div class="container-fluid padded">
			...
			<?php include("message.php");?>
				...
				<div class="box-content padded">
                    ...
                    <tbody>
							<?php 
								$query=mysqli_query($con,"SELECT * FROM practice_question where p_e_id='".$_GET['p_e_id']."' and center_id='".$_SESSION['center_id']."'");
								$i=0;
							...
							?>
								...
								<div class="Table">
									...
									<div class="Row">
										...
										<div class="Cell">
											<input type="radio" name="correct_ans_<?php echo $row['p_q_id'];?>" value="A" <?php if($row['correct_ans']=='A'){echo 'checked="checked"';}?>>
										</div>
										<div class="Cell">
									...
									<div class="Row">
										...
										<div class="Cell">
											<input type="radio" name="correct_ans_<?php echo $row['p_q_id'];?>" value="B" <?php if($row['correct_ans']=='B'){echo 'checked="checked"';}?>>
										</div>
										<div class="Cell">
									...
									<div class="Row">
										...
										<div class="Cell">
											<input type="radio" name="correct_ans_<?php echo $row['p_q_id'];?>" value="C" <?php if($row['correct_ans']=='C'){echo 'checked="checked"';}?>>
										</div>
										<div class="Cell">
									...
									<div class="Row">
										...
										<div class="Cell">
											<input type="radio" name="correct_ans_<?php echo $row['p_q_id'];?>" value="D" <?php if($row['correct_ans']=='D'){echo 'checked="checked"';}?>>
										</div>
										<div class="Cell">
								...
								<?php
									...
									<a data-toggle="modal" href="#modal-status-deactive" onclick="modal_status_deactive('question_status.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>')" class="btn btn-red btn-small"><i class="icon-eye-close"></i> <?php echo constant('TI_DEACTIVATE_BUTTON');?></a>
									<?php }
									else
									{?>														

									<a data-toggle="modal" href="#modal-status-active" onclick="modal_status_active('question_status.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>')" class="btn btn-green btn-small"><i class="icon-eye-open"></i> <?php echo constant('TI_ACTIVATE_BUTTON');?></a>
									<?php }?>	
								</td>
								...
								<td align="center">
								<a data-toggle="modal" href="question_edit.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $row['p_e_id'];?>"  class="btn btn-gray btn-small"><i class="icon-wrench"></i> <?php echo constant('TI_EDIT');?></a>

								<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('question_delete.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>')" class="btn btn-red btn-small"><i class="icon-trash"></i> <?php echo constant('TI_DELETE_BUTTON');?> </a>
...
<div id="modal-delete" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_POPUP_DELETE_QUESTION');?></div>
    <div class="modal-footer">
    	<a href="question_delete.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>" id="delete_link" class="btn btn-red" ><?php echo constant('TI_CONFIRME_BUTTON');?></a>
...
<div id="modal-status-active" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_STATUS_DATA_ACTIVE');?></div>
    <div class="modal-footer">
    	<a href="question_status.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>" id="active_link" class="btn btn-red" ><?php echo constant('TI_CONFIRME_BUTTON');?></a>
        <button class="btn btn-default" data-dismiss="modal"><?php echo constant('TI_CANCEL_BUTTON');?></button>
    </div>
</div>
...
<div id="modal-status-deactive" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_STATUS_DATA_DEACTIVE');?></div>
    <div class="modal-footer">
    	<a href="question_status.php?p_q_id=<?php echo $row['p_q_id'];?>&p_e_id=<?php echo $_GET['p_e_id'];?>" id="deactive_link" class="btn btn-red" ><?php echo constant('TI_CONFIRME_BUTTON');?></a>
        <button class="btn btn-default" data-dismiss="modal"><?php echo constant('TI_CANCEL_BUTTON');?></button>
    </div>
</div>
