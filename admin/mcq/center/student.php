                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
							...
							?>
								...
								<td align="center">
								<a data-toggle="modal" href="student_edit.php?s_id=<?php echo $row['student_id'];?>" class="btn btn-gray btn-small"><i class="icon-wrench"></i> <?php echo constant('TI_EDIT');?></a>

								<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('student_delete.php?s_id=<?php echo $row['student_id'];?>')" class="btn btn-red btn-small"><i class="icon-trash"></i> <?php echo constant('TI_DELETE_BUTTON');?> </a>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">									
                                   ...
                                   <select name="c_id" class="chzn-select">									 
									<?php 
								   $query_center=mysqli_query($con,"select * from center where c_id='".$_SESSION['center_id']."'");
...
<div id="modal-status-active" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_STATUS_DATA_ACTIVE');?></div>
    <div class="modal-footer">
    	<a href="student_status.php?s_id=<?php echo $row['student_id'];?>" id="active_link" class="btn btn-red" ><?php echo constant('TI_CONFIRME_BUTTON');?></a>
        <button class="btn btn-default" data-dismiss="modal"><?php echo constant('TI_CANCEL_BUTTON');?></button>
    </div>
</div>
...
<div id="modal-status-deactive" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo constant('TI_STATUS_DATA_DEACTIVE');?></div>
    <div class="modal-footer">
    	<a href="student_status.php?s_id=<?php echo $row['student_id'];?>" id="deactive_link" class="btn btn-red" ><?php echo constant('TI_CONFIRME_BUTTON');?></a>
        <button class="btn btn-default" data-dismiss="modal"><?php echo constant('TI_CANCEL_BUTTON');?></button>
    </div>
</div>
...
function modal_view_student_profile(param1 ,param2 ,param3)
{
	document.getElementById('modal-body-question').innerHTML = 
		'<iframe id="frame1" src="student_view.php?s_id='+param2+'" width="100%" height="400" frameborder="0"></iframe>';
