...
include('include/left-menu.php');
		...
		{ 		
			...
			$query_question_insert = "insert into practice_question (p_e_id,c_id,s_c_id,center_id,question,typeofquestion,option_a,option_b,option_c,option_d,correct_ans,marks) values('".$_POST['p_e_id']."','".$category_id."','".$s_c_id."','".$center_id."','".$question."','".$typeofquestion."','".$option_a."','".$option_b."','".$option_c."','".$option_d."','".$correct_ans."','".$marks."')"; 
			...
			<?php
				...
				<div class="padded">       
							<div class="control-group">
                                ...
                                <div class="controls">
									<select name="p_e_id" class="validate[required]">
									<option value=""><?php echo constant('TI_DROPDOWN_EXAM');?></option>  
										<?php $query_exam=mysqli_query($con,"select * from practice_exam where center_id='".$_SESSION['center_id']."'");
										while($result_exam=mysqli_fetch_array($query_exam))
										{
										?>
                                    	<option value="<?php echo $result_exam['p_e_id'];?>"><?php echo ucfirst($result_exam['exam_name']);?></option>
			   ...
			   <div class="padded">                   
				...
				<div class="padded">                   
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="validate[required,custom[integer]]" name="marks"  value="<?php echo $res['marks']?>"/>
						</div>
					</div>
				</div>		
