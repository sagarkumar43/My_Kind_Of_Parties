...
(1, 1, 'Online Examination System', 'Online Examination system for Educational Organizations', 'Online Examination System', 'Online Examination System', 'Online Examination System', 'your school.png', 'India', '1111111111', 0, 'bookschool@textusintentio.com', 'UA-58877461-1', 'Certification_LOGO.png', 'certificate<br>', 'signature.png', '<b>Director,</b><br>Online Examination System<br><br>', 'Asia/Kolkata', 'hKvcEYe4gWV5wSxFGJv4NrQy6w+PTDiZE0GT9xuIPxo=');
...
CREATE TABLE IF NOT EXISTS `main_answer` (
  `m_a_id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `subcategory_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `practice_exam` (
  `p_e_id` int(11) NOT NULL AUTO_INCREMENT,
