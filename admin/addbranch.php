...
<div class="col-sm-12">
<div class="white-box">
<h3 class="box-title m-b-0" style="text-align:center;,font-style:dark;">Manage branch details</h3>
<form class="form" method="post">
<div class="row">
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Branch Name:</label>
<input class="form-control" id="id" name="name" type="text"/></div></div><br>
	
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Branch Address:</label>
<input class="form-control" name="bname"  type="text"/></div></div>
	
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Contact Person Name:</label>
<input class="form-control" name="bname"  type="text"/></div></div><br>
	
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Contact Number:</label>
<input class="form-control" name="number"  type="number"/></div></div>	

<div class="row">
<div class="col-lg-12">
<button type="submit" name="save1" class="btn btn-primary">Submit</button></div></div></div></form>
<?php
