                    ...
                    <div class="white-box">
                        <form class="form-material form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <!-- <input id="text" type="text" name="des" class="form-control"> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="myfile" type="file" name="fi" class="form-control">
                                </div>
                            </div>
...
$testimonial="insert into testimonial set name='$name',file_input='$filename',description='$des'";
