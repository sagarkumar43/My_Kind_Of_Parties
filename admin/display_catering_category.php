...
$display_categories="update display_catering_categories set frontend_categories='$category'";

if(mysqli_query($conn, $display_categories)==true)
{
   echo "<script>alert('Categories Update')</script>";
    echo "<script>window.location.href = 'display_catering_category.php'</script>";
}
else
{
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Manage FrontEnd Catering Category</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="">Products</a></li>
                        <li class="active">Manage FrontEnd Catering Category</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                    $display="select * from  display_catering_categories";
