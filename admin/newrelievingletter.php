...
<h4 class="page-title">New Experience Letter</h4></div>
...
<div class="white-box">
<div class="col-sm-12">
<h1 class="box-title m-b-0" style="text-align:center;color: #2121ca;font-size:24px;"><strong>New Experience Letter</strong></h1>
...
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="number">Emp Code:</label>
...
<div class="input-group">
<input class="form-control" id="name" name="name" type="name"/></div></div></div>
	
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">From Date:</label><br>
...
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">To Date:</label><br>
<input style="width:490px; height:35px;" type="date" id="myDate" value="2010-01-01"></div></div>
...
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Guradian Name:</label>
<div class="input-group">
<input class="form-control" id="name" name="name" type="name"/></div></div></div>
	
</div><button type="button" class="btn btn-primary">Submit</button>
<a href="Relievingletter.php" class="btn btn-primary">Back</a></form>
</div></div></div>
