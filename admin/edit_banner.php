        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Edit New Banner</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="manage_banner.php">Banner</a></li>
                        <li class="active">Edit New Banner</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<?php
   $cmanagment="select * from banner_image where id='$id'";
   ...
   ?>
                        <form class="form-material form-horizontal" method="post" enctype=multipart/form-data>
                            ...
                            <select class="selectpicker form-control" name="slctcategory" data-live-search="true" required>
                                ...
                                <option value="<?php echo $fetch_banner['selected_menu']; ?>"><?php echo $fetch_banner['selected_menu']; ?></option>
                            ...
                            <img src="../vendor/images/Banner/<?php echo $fetch_banner['banner_pic'] ?>" alt="" style="width: 7%;">
                        ...
                        move_uploaded_file($filetmp, "../vendor/images/Banner/".$filename);
                        
                        if($filename=="")
                        {
                            $filecondition=$fetch_banner["banner_pic"];
                        }
                        else{
                            $filecondition=$filename;
                        }
                        
                        $display_categories="update banner_image set selected_menu='$category',banner_pic='$filecondition' where id='$id' ";
                        ...
                        {
                            echo "<script>alert('Banner not Update')</script>";
                            echo "<script>window.location.href = 'manage_banner.php'</script>";
                        }
                        }
                        ?>
