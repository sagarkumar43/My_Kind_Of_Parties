                        ...
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="sdate" name="sdate" class="form-control mydatepicker" placeholder="enter date here">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="duration">Course Duration</label>
                                    <div class="col-md-12">
                                        <input type="text" id="duration" name="duration" class="form-control" placeholder="time span of the course">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="price">Course Price</label>
                                    <div class="col-md-12">
                                        <input type="text" id="price" name="price" class="form-control" placeholder="course fees">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="professor">Course Professor</label>
                                    <div class="col-md-12">
                                        <input type="text" id="professor" name="professor" class="form-control" placeholder="professor name">
                                    </div>
                                </div>
                                <div class="form-group">
