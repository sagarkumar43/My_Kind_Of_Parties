...
$id=$_GET['id'];
 ...
 $get_user="select * from vendor_user where v_id='".$id."'";
...
$read_user=mysqli_fetch_array($run_user);
	...
	v_phone='$phone',v_address='$address',v_website='$website',v_status='$status' where v_id='$id'" ;
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                       <input id="website" type="text" value="<?php echo $read_user['v_name'];?>" name="v_name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="sdate">Vendor Email</label>
                                    <div class="col-md-12">
                                       <input id="phone" type="email" value="<?php echo $read_user['v_email'];?>" name="v_email" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="duration">Vendor Phone</label>
                                    <div class="col-md-12">
                                       <input id="phone" type="text" value="<?php echo $read_user['v_phone'];?>" name="v_phone" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="price"> Vendor Website</label>
                                    <div class="col-md-12">
                                      <input id="website" type="text" value="<?php echo $read_user['v_website'];?>" name="v_website" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="professor">Vendor Address</label>
                                    <div class="col-md-12">
                                     <input id="password" type="text" value="<?php echo $read_user['v_address'];?>" name="v_address" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="status">
                                            <option value="<?php echo $read_user['v_status'];?>"><?php echo $read_user['v_status'];?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                   <input id="text" type="text" value="<?php echo $read_user['v_pass'];?>" name="v_pass" class="form-control">
                                    </div>
                                </div>
