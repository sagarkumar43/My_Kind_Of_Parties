...
<h4 class="page-title">ADMISSION DETAILS</h4></div>
...
<div class="white-box">
<div class="col-sm-12">
<h1 class="box-title m-b-0" style="text-align:center;color: #2121ca;font-size:24px;"><strong>ADMISSION DETAILS</strong></h1>
...
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Course Duration:</label>
<select  class="form-control" >
<option>Please Select</option>
<option>3 Months</option>
<option>6 Months</option>
<option>8 Months</option>
<option>1 Year to 1.5 years</option>
<option>1.5 Year to 2 years</option>
<option>3 Years</option>
</select></div></div>
	
<div class="col-lg-6">
<div class="form-group">
<label class="control-label" for="name">Total Fees:</label>
<div class="input-group">
<input class="form-control" id="email" name="email" type="text"/></div></div></div>
