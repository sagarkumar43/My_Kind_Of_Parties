...
move_uploaded_file($filetmp, "../images/promoted_banner_image/".$filename);
	...
	$limit="SELECT COUNT(*) AS count1 FROM promotional_banner where banner_category='$category'";
    $exe=mysqli_query($conn, $limit);
    $read_count=mysqli_fetch_array($exe);
    $count=$read_count["count1"];
    if($count >=2){

        echo "<script>alert('Allow only 2 Banners in a single category')</script>";
        echo "<script>window.location.href = 'promoted_banner.php'</script>";
    }
    else
    {

$display_categories="insert into promotional_banner set banner_category='$category',banner_links='$link',banner_image='$filename'";
                    ...
                    <div class="white-box">
                        ...
                        <form class="form-material form-horizontal" method="post" enctype=multipart/form-data>
                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Category
                                </label>
                            </div>
                            ...
                            <select class="selectpicker form-control" name="slctcategory" data-live-search="true" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                       <input id="website" type="url" value="" name="link" placeholder="www.example.com" class="form-control">
                                    </div>
                                </div>

                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Select Banner Image
                                </label>
                            </div>
