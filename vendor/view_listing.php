...
<form method="post" action="" id="myform" enctype="multipart/form-data">
 <div class="row">
  ...
  <input id="list-title" type="text" name="listing_name" value="<?php echo $row['listing_name'];?>" class="validate" readonly>
...
<div class="col-md-12">
<input id="website" value="<?php echo $row['address'];?>" type="text" name="address" class="form-control" readonly></div></div>

<div class="form-group">
<label class="col-md-12" for="example-text">Price Per Day</span></label>
<div class="col-md-12">
<input id="website" value="<?php echo $row['price'];?>" type="text" name="price" class="form-control" readonly></div></div>
											
<div class="form-group">
<label class="col-md-12" for="example-text">Rooms</span></label>
<div class="col-md-12">
<input id="website" value="<?php echo $row['rooms'];?>" type="text" name="rooms" class="form-control" readonly></div></div>
											
<div class="form-group">
<label class="col-md-12" for="example-text">Guest</span></label>
<div class="col-md-12">
<input id="website" value="<?php echo $row['guest'];?>" type="text" name="guest" class="form-control" readonly></div></div>									
...
<div class="row">
<div class="input-field col s6">
<input id="t4-soc1" type="text" name="facebook" value="<?php echo $row['facebook'];?>" class="validate" readonly>
<label for="t4-soc1">Facebook Url</label></div>

<div class="input-field col s6">
<input id="t4-soc2" type="text" name="googleplus"  value="<?php echo $row['googleplus'];?>"class="validate" readonly>
<label for="t4-soc2">Google Plus Url</label></div></div>
                                    
<div class="row">
<div class="input-field col s6">
<input id="t4-soc3" type="text" name="twitter" value="<?php echo $row['twitter'];?>" class="validate" readonly>
<label for="t4-soc3">Twitter Url</label></div>

<div class="input-field col s6">
<input id="t4-soc5" type="text" name="whatsapp_no" value="<?php echo $row['whatsapp_no'];?>" class="validate" readonly>
...
<div class="row">
<div class="input-field col s6">
<input id="t5-n1" type="text" class="validate" value="<?php echo $row['vendor_name'];?>" name="vendor_name" readonly>
<label for="t5-n1">Contact Name</label></div>

<div class="input-field col s6">
<input id="t5-n4" type="number" value="<?php echo $row['vendor_phone'];?>" name="vendor_phone" class="validate" readonly>
<label for="t5-n4">Mobile</label></div></div>
                                    
<div class="row">
<div class="input-field col s12">
<input id="t5-n5" type="email" name="vendor_email" value="<?php echo $row['vendor_email'];?>" class="validate" readonly>
...
<textarea id="details" class="materialize-textarea" name="details" readonly><?php echo $row['details'];?></textarea>
...
for( $i=0 ; $i < $total ; $i++ ) {
 ...
 echo $add_listing="update vendor_listing set listing_name='$listing_name',city='$city',address='$address',price='$price',
