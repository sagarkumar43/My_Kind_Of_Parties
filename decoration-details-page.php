...
$categories_name=$read_listing['category_name'];
$featureimage=$read_listing['feature_image'];
$productname=$read_listing['product_name'];
...
<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>MYKOP <?php echo $productname ?></title>
    <meta name="viewport"
				  ...
				  ?>
                        <div class="slick-slide-item">
                            <div class="box-item">
                                ...
                                <img src="admin/img/product_img/slider_img/<?php echo $gallery?>"
                                    alt="">
                                <a href="admin/img/product_img/slider_img/<?php echo $gallery?>"
                        ...
                        <div class="container">
                            <nav class="scroll-nav scroll-init">
                                <ul>
                                    ...
                                    <li><a href="#sec7">Need To Know</a></li>
                                ...
                                <div class="list-single-main-container ">
                                    ...
                                    <div class="breadcrumbs inline-breadcrumbs fl-wrap"
                                        ...
                                        <a href="index.php">Home</a><a href="#">
                                            <?php echo $read_listing['product_name']?>
                                        </a>
                                    </div>
                                    ...
                                    <div class="list-single-main-item fl-wrap" id="sec3"
                                        ...
                                        <p>
                                            <?php echo $read_listing['product_desciption']; ?>
                                        </p>
                                    ...
                                    <div class="list-single-main-item fl-wrap listnone" id="sec5"
                                        ...
                                        <?php
                                            $q="select * from product_mgmt where id='$list_id'";
                                        ...
                                        ?>
                                                ...
                                                <p>
                                                    <?php echo $read['product_inclusion']; ?>
                                           </p>
                                        <?php } ?>
                                    ...
                                    <div class="list-single-main-item fl-wrap listnone" id="sec9"
                                        ...
                                        ?>
                                                ...
                                                <p>
                                                    <?php echo $read['cancellation_policy']; ?>
                                                </p>
                                        ...
                                        <div id="add-review" class="add-review-box">
                                            ...
                                            <?php
                                                if(isset($_POST['submitreview']))
                                                {
                                                    ...
                                                    $insert="insert into decoration_review set customer_name='$name',customer_email='$email',customer_msg='$reviewmsg',customer_star_rating='$star',product_image='$featureimage',product_name='$productname',product_id='$product_id',Status='Pending'";
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="product_name"
                                                                    ...
                                                                    value="<?php echo $read_listing['product_name']; ?>"
                                                                    readonly required>
                                        ...
                                        <div class="box-widget">
                                            <div class="box-widget-content">
                                                ...
                                                <div class="widget-posts fl-wrap">
                                                    <ul>
                                                        <?php
														$get_listingcities="select * from product_mgmt where category_name='$url_cat'";
                                                        ...
                                                        <li class="clearfix">
                                                            ...
                                                            <div class="widget-posts-descr">
                                                                ...
                                                                <!-- <div class="geodir-category-location fl-wrap"><a
                                                                        href="listingdetailpage.php?id=7"><i
                                                                            class="fas fa-map-marker-alt"></i> Essex
                                                                        Farms, 4, Sri Aurobindo Marg, New Delhi, Delhi
                                                                        110016</a></div> -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo $read_listing['product_name']; ?></h4>
        </div>
        <div class="modal-body" style="padding: 180px!important;">
        <video id="" width="100%" controls >
          <source src="admin/img/product_img/product_video/<?php echo $read_listing["product_video"];?>" type="video/mp4">
        </video>
        </div>
