  ...
  ?>
                    ...
                    <div class="container">
                        <div class="section-title center-align big-title">
                            ...
                            <!-- <h3></h3> -->
                            <h2><span><?php echo $cate ?></span></h2>
                            <h2><span style="font-size: 25px;">Decoration's</span></h2>
                ...
                <div class="list-main-wrap fl-wrap card-listing">
                                        ...
                                        <div class="listing-item-container init-grid-items fl-wrap">
                                            ...
                                            <?php
                                            $q="select * from product_mgmt where category_name='$cate'";
                                            $ex=mysqli_query($conn,$q);
                                            while($read=mysqli_fetch_array($ex))
                                        { ?>
                                            <div class="listing-item" style="margin-left: 12.5px;">
                                                <article class="geodir-category-listing fl-wrap">
                                                    <div class="geodir-category-img">
                                                        <a href="decoration-details-page.php?openid=<?php echo $read['id']; ?>&cat_name=<?php echo $read['category_name']; ?>"><img src="admin/img/product_img//<?php echo $read['feature_image']; ?>" alt=""></a>
                                                    ...
                                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                                        <div class="geodir-category-content-title fl-wrap">
                                                            <div class="geodir-category-content-title-item">
                                                                <h3 class="title-sin_map"><a href="decoration-details-page.php?openid=<?php echo $read['id']; ?>&cat_name=<?php echo $read['category_name']; ?>"><?php echo $read['product_name']; ?></a></h3>
                                                                <div class="geodir-opt-list">
                                                                
                                                                

                                                            </div>
                                                                <div class="geodir-category-location fl-wrap"><a href="decoration-details-page.php">
                                                        ...
                                                        <?php  for($i=0; $i<=140; $i++)
            { 
              echo $read["product_desciption"][$i];
            } ?>
                                                        <p>
                                                       <br> 
                                                            <a href="decoration-details-page.php?openid=<?php echo $read['id']; ?>&cat_name=<?php echo $read['category_name']; ?>" class="btn btn-primary" style="background:linear-gradient(to right, #ffc800, #1b1e1d, #354078);border: none;">View More Details</a>
                                                        </p>
