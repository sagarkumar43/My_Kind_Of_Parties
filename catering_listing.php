...
<body>
  ...
  ?>
                    ...
                    <div class="container">
                        <div class="manual">
                            ...
                            <div>
                                ...
                                <img src="images/Catering images/<?php echo $read['category_image']; ?>" alt="" class="img">
                ...
                <!--  section-->
                <?php
                    $display_category="SELECT * FROM  display_catering_categories";
                ...
                <section class="grey-blue-bg">
                    ...
                    <div class="list-carousel fl-wrap card-listing ">
                        ...
                        <div class="listing-carousel  fl-wrap ">
                            <!--slick-slide-item-->
                            <?php
                                $q="SELECT * FROM catering_product WHERE catering_category='$dis_cate_name'";
                                $ex=mysqli_query($conn,$q);
                                $count=1;
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            <a href="catering_details_page.php?openid=<?php echo $fetch['id']; ?>&cat_name=<?php echo $fetch['catering_category']; ?>"><img src="images/Catering%20images/upload/<?php echo $fetch['feature_image']; ?>" style="height: 246px;"></a>
                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <center>
                                                        <h3 class="title-sin_map"><a href="catering_details_page.php?openid=<?php echo $fetch['id']; ?>&cat_name=<?php echo $fetch['catering_category']; ?>"><?php echo $fetch['prodcut_name']; ?> </a></h3>
                                                        <div class="geodir-category-location fl-wrap">
                                                            <a href="catering_details_page.php?openid=<?php echo $fetch['id']; ?>&cat_name=<?php echo $fetch['catering_category']; ?>" class="map-item"><b
